...
<head>
    ...
    <link rel="shortcut icon" href="./templates/images/Logo/logo-foursquare.svg">
    ...
    <div class="section">
        <div class="container">
            ...
            <div class="movies-slide carousel-nav-center owl-carousel">
                ...
                <!-- MOVIE ITEM -->
                <a href="#" class="movie-item">
                    <img src="./templates/images/cartoons/croods.jpg" alt="">
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            Croods
                        </div>
                ...
                <!-- MOVIE ITEM -->
                <a href="#" class="movie-item">
                    <img src="./templates/images/cartoons/dragon.jpg" alt="">
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            Dragonball
                        </div>
                ...
                <!-- MOVIE ITEM -->
                <a href="#" class="movie-item">
                    <img src="./templates/images/cartoons/over-the-moon.jpg" alt="">
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            Over The Moon
                        </div>
                ...
                <!-- MOVIE ITEM -->
                <a href="#" class="movie-item">
                    <img src="./templates/images/cartoons/weathering.jpg" alt="">
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            Weathering With You
                        </div>
                ...
                <!-- MOVIE ITEM -->
                <a href="#" class="movie-item">
                    <img src="./templates/images/cartoons/your-name.jpg" alt="">
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            Your Name
                        </div>
                ...
                <!-- MOVIE ITEM -->
                <a href="#" class="movie-item">
                    <img src="./templates/images/cartoons/coco.jpg" alt="">
                    <div class="movie-item-content">
                        <div class="movie-item-title">
                            Coco
                        </div>
