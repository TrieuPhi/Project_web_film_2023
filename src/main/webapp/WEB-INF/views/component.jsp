...
<head>
     ...
     <link rel="stylesheet" href="./templates/CSS/assets/grid.css">
                    ...
                    <div class="movie-card-content">
                         ...
                         <div class="movie-casts">
                              <div class="movie-cast-item">
                                   <img src="./templates/Images/Raya_and_the_last_dragon/screenshot-1.jpg" alt="cast1">
                              </div>
                              <div class="movie-cast-item">
                                   <img src="./templates/Images/Raya_and_the_last_dragon/screenshot-2.jpg" alt="cast1">
                              </div>
                              <div class="movie-cast-item">
                                   <img src="./templates/Images/Raya_and_the_last_dragon/screenshot-3.jpg" alt="cast1">
                              </div>
                              <div class="movie-cast-item">
                                   <img src="./templates/Images/Raya_and_the_last_dragon/screenshot-4.jpg" alt="cast1">
                              </div>
                         </div>
                    </div>
               </div>
