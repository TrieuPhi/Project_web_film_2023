...
<body>
	...
	<div class="container">
		<div class="nav bg-color">
			<a href="index.html" class="logo"> <i style="margin-right: 10px;"
			...
			<div class="nav-sign">
				<a href="signin-signup" class="btn btn-hover"> <span>Sign
						in</span>
				</a>
	...
	<section class="movie-banner">
		<div class="hero-wrapper">
			<div class="movie-banner-item">
				<img src="./templates/images/raya3.jpg" alt="">
			</div>

			<div class="movie-card">
				<img src="./templates/images/raya1.jpg" alt="raya">
				...
				<div class="movie-card-content">
					...
					<ul class="movie-card-btns">
						<li class="movie-card-btn">family</li>
						<li class="movie-card-btn">Fantacy</li>
						<li class="movie-card-btn">animation</li>
						<li class="movie-card-btn">action</li>
						<li class="movie-card-btn">adventure</li>
					</ul>

					<p class="movie-card-description">Lorem ipsum dolor sit amet
						consectetur adipisicing elit. Quas, possimus eius. Deserunt non
						odit, cum vero reprehenderit laudantium odio vitae autem quam,
					...
					<div class="movie-casts">
						<div class="movie-cast-item">
							<img
								src="./templates/images/Raya_and_the_last_dragon/screenshot-1.jpg"
								alt="cast1">
						</div>
						<div class="movie-cast-item">
							<img
								src="./templates/images/Raya_and_the_last_dragon/screenshot-2.jpg"
								alt="cast1">
						</div>
						<div class="movie-cast-item">
							<img
								src="./templates/images/Raya_and_the_last_dragon/screenshot-3.jpg"
								alt="cast1">
						</div>
						<div class="movie-cast-item">
							<img
								src="./templates/images/Raya_and_the_last_dragon/screenshot-4.jpg"
								alt="cast1">
						</div>
					</div>
				</div>
